...
test('UI : DataMatrix/GS1',()=>assert.ok(app.includes("'data_matrix'")&&html.includes('GS1 · DataMatrix')));
...
console.log(`Scanner Pro v6.5.5 : ${pass}/${pass+fail}`);if(fail)process.exit(1);
