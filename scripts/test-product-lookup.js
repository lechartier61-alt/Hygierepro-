...
const { normalizeBarcode, mapOpenFoodFactsProduct, mapUpcItemDbItem } = await import('../src/utils/product-data.js');
...
console.log(`Base Produits Internet v6.6.0 : ${pass}/15`);
