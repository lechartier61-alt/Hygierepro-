...
<tr><td style="padding:26px 34px 14px"><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td bgcolor="#FFFFFF" style="background:#FFFFFF;border:1px solid #E4ECE7;border-radius:14px;padding:10px 14px"><a href="${esc(home)}" style="display:block;text-decoration:none;background:#FFFFFF"><img src="${esc(logo)}" width="210" alt="HygieSafe" style="display:block;width:210px;max-width:100%;height:auto;border:0;background:#FFFFFF"></a></td></tr></table></td></tr>
